...
namespace ContactsRestWebAPI.Controllers
{
    public class MyContactsController : ApiController
    {
        ...
        // POST api/MyContacts
        [ResponseType(typeof(contact))]
        public IHttpActionResult PostContact(contact objcontact)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = objcontact.contactId }, objcontact);
        }
        ...
        public IHttpActionResult PutCustomer(int id, contact objcontact)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            if (id != objcontact.contactId)
            {
                return BadRequest();
            }

            contact objContactToModify = contactList.Where(x => x.contactId == id).Single();
            objContactToModify = objcontact;
